 ...
 */
    ...
    class QRcode {
        ...
        //----------------------------------------------------------------------
        public static function svg($text, $outfile = false, $level = false, $size = 5, $margin = 4, $saveandprint=false, $back_color = 0xFFFFFF, $fore_color = 0x000000)
        {
            if ( ! $level ) {
                $level = QR_ECLEVEL_L ;
            }
